...
- In my master's thesis project, I treated the relation between the corporate responsibility and the flow distribution of the investment funds from LATAM.
  There I found that, funds with higher corporate responsibility score increase the probability of in-flows, which implies a higher first and third moment of the funds' flows distribution. [Here is my work]([https://github.com/user-attachments/files/16132927/Tesis_MgFinFT_Zenteno_J.pdf](https://repositorio.uchile.cl/handle/2250/199648)).
...
- ¡Here is my [CV](https://github.com/user-attachments/files/20358190/Julian.Arturo.Zenteno.Santibanez.pdf) and my [Web Page](https://sites.google.com/fen.uchile.cl/julianzentenos)!
